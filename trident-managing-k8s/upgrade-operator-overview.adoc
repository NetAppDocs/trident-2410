...
TIP: For more information about Astra Trident architecture on the Kubernetes cluster, refer to link:../trident-get-started/intro.html#astra-trident-architecture[Astra Trident architecture].
